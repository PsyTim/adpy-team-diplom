...
class TestRecreateTables(unittest.TestCase):
    ...
    def test_recreate_and_fill_autorization_code(self, skip=True, add_fill={}):
        ...
        user.refresh_token = "vk2.a.0_w2nEXumTXE0gbdD5mnE0fOET9-SE6xUulyUggMS9i3OV7ZnXc_sEpFyu72YfPFNuabCstzfq5_6311jfjGXuxgqMdByaPPLjVIcUW69_aLJ8tzlx4oz0wKubgJ4Or5ki5Dy78zTxaNS2TjIMw1lddTdXnDbe9lITzyd0WgpnnbhskT7tjap0HnK-xhxKa1KFq8p1zAhEHlzpQkg5BQ4kADby6Hwe0jMEkGqfTxHEU"
        user.device_id = "ymY4i4XRJfsmcRX7R2IxWJeqG55dWImhv2pTfhB2E0pr_ZylFjnYQWsu7JEF3q66oEIyvg-wK0eNxp6iLZQvyw"
